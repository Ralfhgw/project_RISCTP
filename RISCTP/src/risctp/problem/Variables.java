...
// $Id: Variables.java,v 1.2 2022/07/22 09:33:07 schreine Exp $
//
...
public class Variables extends ASTCloner
{
  /****************************************************************************
   * Replace constants annotated with variable symbols by variables.
   * @param problem a proof problem.
   * @return an equivalent problem with variables.
   ***************************************************************************/
  public static ProofProblem process(ProofProblem problem)
  {
    Variables cloner = new Variables(problem);
  ...
  private Variables(ProofProblem problem)
  {
    super(false);
